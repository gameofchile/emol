...
var createFlashTester = require('http://www.emol.com/noticias/Nacional/2017/12/03/885860/flashTester.js').createFlashTester;
...
VASTIntegrator.prototype._addSkipButton = function addSkipButton(source, tracker, response, callback) {
  ...
  function updateSkipButtonState(skipButton, skipOffset, player) {
    ...
    if (timeLeft > 0) {
      skipButton.innerHTML = "Anuncio publicitario <br />" + utilities.toFixedDigits(timeLeft, 2) + " segundos";
    } else {
      if (!dom.hasClass(skipButton, 'enabled')) {
...
function urlParts(url) {
  ...
  return {
    ...
    pathname: (urlParsingNode.pathname.charAt(0) === 'http://www.emol.com/')
