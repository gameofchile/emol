...
function  asyncPub(doc, win, id, product) {
    var ID = id;
        ...
        //if (!win.reviveAsync.hasOwnProperty(ID)) {
            var rv = win.reviveAsync[ID] = {
                ...
                apply: function (data) {
            		...
            		var url = "//rvv.emol.com/www/noticias/condor.php";
                 ...
                 * @returns JQuery
                 */
                createSpan: function (data) {
                    var i = doc.createElement('span');
                    i.className += "cont_txt_publi_emol";    
                    i.innerHTML += "Publicidad";    
                    return i;
                },                
                ...
                loadFrame: function (iframe, html) {
                    ...
                    d.writeln('<body border="0" margin="0" style="margin: 0">');
                    d.writeln(html);
                    d.writeln('</body>');
                    d.writeln('</html>');
                    d.close();
                    ...
                    for (var id in data) {
                        if (data.hasOwnProperty(id)) {
                            ...
                            if (ins) {
                                ...
                                if (d.iframeFriendly) { 
                                    //var z = rv.createSpan(d);
                                    var i = rv.createFrame(d);
                                    //newIns.appendChild(z);
...
(function () { 
    setTimeout(function(){asyncPub(document, window,'c11e08c9c60eca20c9ed00ceea3f3c6b','revive')},7000);
})();
